...
return {
	...
	-- CURLY BRACES
	s(
		{ trig = "fds", snippetType = "autosnippet", priority = 1000 },
		fmta(
			[[
        {
            <>
	...
	-- constructor
	s(
		{ trig = "puu", snippetType = "autosnippet" },
		fmta(
			[[
          public <>(<>) {
              <>
	...
	-- public function
	s(
		{ trig = "pff", snippetType = "autosnippet" },
		fmta(
			[[
          public <> <>(<>) {
              <>
	...
	s(
		{ trig = "psf", snippetType = "autosnippet" },
		fmta(
			[[
          public static <> <>(<>) {
              <>
	...
	-- private function
	s(
		{ trig = "pvv", snippetType = "autosnippet" },
		fmta(
			[[
          private <> <>(<>) {
              <>
	...
	s(
		{ trig = "fjj", snippetType = "autosnippet" },
		fmta(
			[[
          for (int j = 0; j <>; j++) <>
        ]],
	...
	-- Integer.parseInt()
	s(
		{ trig = "ipi", snippetType = "autosnippet" },
		fmta(
			[[
          Integer.parseInt(<>)
        ]],
	...
	-- Double.parseDouble()
	s(
		{ trig = "dpd", snippetType = "autosnippet" },
		fmta(
			[[
          Double.parseDouble(<>)
        ]],
	...
	s(
		{ trig = ";io", snippetType = "autosnippet" },
